...
import { buttonText } from '../Button/Button.module.css';
import { Button } from "../Button";

export function SearchBar() {
  return (
    <div className={styles.searchBar}>
      <input type="search" placeholder="Search for products" className={styles.searchBar__input} />
      <Button selector="searchBar__button">
